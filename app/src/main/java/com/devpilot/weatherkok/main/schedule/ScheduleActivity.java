package com.devpilot.weatherkok.main.schedule;
...
import com.devpilot.weatherkok.main.schedule.utils.ScheduleRecyclerViewAdapter;
...
//        AM am = new AM();
//        am.setCloud("구름 많음");
//        am.setRainPercent("강수 많음");
//        am.setWxCondition("눈 많음");
//        am.setTempMin(23);
//        am.setWindy("강풍");
//
//        PM pm = new PM();
...
//
//                scheduleData.setPlace(address.getAddressLine(0));
//
...
//        String a = loadedFromSP.getPlace();
//
//        Log.i("loaded : ", a);
