...
public class WxItem {
    private static final String TAG = WxItem.class.getSimpleName();
     public String regId;

        public int rnSt0Am;
        public int rnSt0Pm;
        public int rnSt0AmType;
        public int rnSt0PmType;
        public String wf0Am;
        public String wf0Pm;

        public int rnSt1Am;
        public int rnSt1Pm;
        public int rnSt1AmType;
        public int rnSt1PmType;
        public String wf1Am;
        public String wf1Pm;

        public int rnSt2Am;
        public int rnSt2Pm;
        public int rnSt2AmType;
        public int rnSt2PmType;
        public String wf2Am;
        public String wf2Pm;
        ...
        public int getRnSt0AmType() {
            return rnSt0AmType;
        }

        public void setRnSt0AmType(int rnSt0AmType) {
            this.rnSt0AmType = rnSt0AmType;
        }

        public int getRnSt0PmType() {
            return rnSt0PmType;
        }

        public void setRnSt0PmType(int rnSt0PmType) {
            this.rnSt0PmType = rnSt0PmType;
        }

        public int getRnSt1AmType() {
            return rnSt1AmType;
        }

        public void setRnSt1AmType(int rnSt1AmType) {
            this.rnSt1AmType = rnSt1AmType;
        }

        public int getRnSt1PmType() {
            return rnSt1PmType;
        }

        public void setRnSt1PmType(int rnSt1PmType) {
            this.rnSt1PmType = rnSt1PmType;
        }

        public int getRnSt2AmType() {
            return rnSt2AmType;
        }

        public void setRnSt2AmType(int rnSt2AmType) {
            this.rnSt2AmType = rnSt2AmType;
        }

        public int getRnSt2PmType() {
            return rnSt2PmType;
        }

        public void setRnSt2PmType(int rnSt2PmType) {
            this.rnSt2PmType = rnSt2PmType;
        }

        public int getRnSt0Am() {
            return rnSt0Am;
        }

        public void setRnSt0Am(int rnSt0Am) {
            this.rnSt0Am = rnSt0Am;
        }

        public int getRnSt0Pm() {
            return rnSt0Pm;
        }

        public void setRnSt0Pm(int rnSt0Pm) {
            this.rnSt0Pm = rnSt0Pm;
        }

        public String getWf0Am() {
            return wf0Am;
        }

        public void setWf0Am(String wf0Am) {
            this.wf0Am = wf0Am;
        }

        public String getWf0Pm() {
            return wf0Pm;
        }

        public void setWf0Pm(String wf0Pm) {
            this.wf0Pm = wf0Pm;
        }

        public int getRnSt1Am() {
            return rnSt1Am;
        }

        public void setRnSt1Am(int rnSt1Am) {
            this.rnSt1Am = rnSt1Am;
        }

        public int getRnSt1Pm() {
            return rnSt1Pm;
        }

        public void setRnSt1Pm(int rnSt1Pm) {
            this.rnSt1Pm = rnSt1Pm;
        }

        public String getWf1Am() {
            return wf1Am;
        }

        public void setWf1Am(String wf1Am) {
            this.wf1Am = wf1Am;
        }

        public String getWf1Pm() {
            return wf1Pm;
        }

        public void setWf1Pm(String wf1Pm) {
            this.wf1Pm = wf1Pm;
        }

        public int getRnSt2Am() {
            return rnSt2Am;
        }

        public void setRnSt2Am(int rnSt2Am) {
            this.rnSt2Am = rnSt2Am;
        }

        public int getRnSt2Pm() {
            return rnSt2Pm;
        }

        public void setRnSt2Pm(int rnSt2Pm) {
            this.rnSt2Pm = rnSt2Pm;
        }

        public String getWf2Am() {
            return wf2Am;
        }

        public void setWf2Am(String wf2Am) {
            this.wf2Am = wf2Am;
        }

        public String getWf2Pm() {
            return wf2Pm;
        }

        public void setWf2Pm(String wf2Pm) {
            this.wf2Pm = wf2Pm;
        }
