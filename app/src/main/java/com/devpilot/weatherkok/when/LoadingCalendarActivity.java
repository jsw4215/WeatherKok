...
import com.devpilot.weatherkok.intro.CustomAnimationDialog;
...
import com.devpilot.weatherkok.when.utils.LunaCalendar;
...
public class LoadingCalendarActivity extends BaseActivity implements RestContract.ActivityView, Runnable {
    ...
    Context mContext;
    int receiveCnt=0;
    public CustomAnimationDialog progressDoalog;
...
//
    ...
    private void getFromholidayApi(String year, String month) {
        ...
        String serviceKey = getString(R.string.holiday_key);
        String type = "json";
