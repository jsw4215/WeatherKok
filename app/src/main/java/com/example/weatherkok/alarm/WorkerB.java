...
import static com.example.weatherkok.alarm.Constants.NOTIFICATION_INTERVAL_HOUR;
...
public class WorkerB extends Worker {
    ...
    public Result doWork() {
        ...
        if (isEventANotifyAvailable) {
            mNotificationHelper.createNotification(WORK_B_NAME);
        } else {
            long notificationDelay = NotificationHelper.getNotificationDelay(WORK_B_NAME);
